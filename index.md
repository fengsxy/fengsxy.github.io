...
<style>
  ...
  @media (prefers-color-scheme: dark) {
    ...
    .experience-role { color: #eee; }
    .experience-meta,
    .experience-date { color: #bbb; }
    .experience-company { color: #ddd; }
  }
</style>

<div class="experience-list">
  <div class="experience-item">
    <div class="experience-mark experience-mark-aws" aria-hidden="true">aws</div>
    <div>
      <div class="experience-role">Applied Scientist Intern</div>
      <div class="experience-meta"><span class="experience-company">Amazon Web Services (AWS)</span> · New York</div>
    </div>
    <div class="experience-date">2026.06 – Present</div>
  </div>
  <div class="experience-item">
    <div class="experience-mark experience-mark-mp" aria-hidden="true">MP</div>
    <div>
      <div class="experience-role">Research Assistant</div>
      <div class="experience-meta"><span class="experience-company">MiraclePlus</span> · Beijing</div>
    </div>
    <div class="experience-date">2025.03 – 2025.08</div>
  </div>
  <div class="experience-item">
    <div class="experience-mark experience-mark-xorbits" aria-hidden="true">X</div>
    <div>
      <div class="experience-role">Software Engineer Intern / OSPP</div>
      <div class="experience-meta"><span class="experience-company">Xorbits</span></div>
    </div>
